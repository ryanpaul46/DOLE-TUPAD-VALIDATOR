    ...
    <Container fluid className="p-4">
      ...
      <Row>
        <Col md={6} className="mb-3">
          <Button variant="primary" size="lg" className="w-100" onClick={() => navigate("/admin/users")}>Manage Users</Button>
        </Col>
        <Col md={6} className="mb-3">
          <Button variant="secondary" size="lg" className="w-100" onClick={() => navigate("/admin/database")}>View Database</Button>
        </Col>
      </Row>
    </Container>
  );
